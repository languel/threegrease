...
const PATHS: Record<string, string> = {
  ...
  // drawing objects in place (tools/objectdraw.ts)
  drawPlane: 'M2.5 15.5 9 9h12.5L15 15.5ZM9 9v-.01',
  drawRect: 'M3 6.5 9.5 4 21 7.5 14.5 10Z',
  drawTriangle: 'M12 4 21 19H3Z',
  drawPolygon: 'M12 3l7.5 4.5v9L12 21l-7.5-4.5v-9Z',
  drawCylinder: 'M6 8c0-1.1 2.7-2 6-2s6 .9 6 2-2.7 2-6 2-6-.9-6-2ZM6 8v8c0 1.1 2.7 2 6 2s6-.9 6-2V8',
  drawPyramid: 'M12 3 21 18H3ZM12 3v15',
  drawTetra: 'M12 3 21 18 3 16.5ZM12 3 3 16.5M12 3l9 15',
  drawOcta: 'M12 2 20 12l-8 10L4 12ZM4 12h16',
  drawDodeca: 'M12 2.5 19.5 8l-2.9 9H7.4L4.5 8ZM7.4 17 12 21.5 16.6 17M4.5 8 12 10.5 19.5 8M12 10.5V21.5',
  drawIcosa: 'M12 2.5 20 8v8l-8 5.5L4 16V8ZM4 8l8 5 8-5M12 13v8.5M4 16l8-3 8 3',
  ...
  // ...crossed out: this object is left out of the output windows
  monitorOff: 'M3.75 4.5h16.5v11.25H3.75ZM9 19.5h6M12 15.75v3.75M3 3l18 18',
