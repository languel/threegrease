...
export class UI {
  ...
  refreshTimelineControls(): void {
    ...
    controls.replaceChildren(
      ...
      this.cameraSelect(),
      btn(icon('camera'), () => this.app.addCamera(), { cls: 'icon-btn', title: 'Add a camera at the current view' }),
      btn(icon('trash'), () => this.app.removeCamera(), { cls: 'icon-btn', title: 'Delete the active camera' }),
      checkbox('Lock', this.app.lockCamToView, (v) => { this.app.lockCamToView = v; }),
      btn(icon('key'), () => this.app.addCameraKey(), { cls: 'icon-btn', title: 'Keyframe the camera at the current frame' }),
      btn(icon('trash'), () => this.app.removeCameraKeyAtFrame(), { cls: 'icon-btn', title: 'Remove camera key at current frame' }),
